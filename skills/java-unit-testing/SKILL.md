...
description: 阿里巴巴Java开发手册单元测试规约。Use when writing unit tests, test cases, or testing Java code. Make sure to use this skill whenever the user asks about unit testing, JUnit, test coverage, AIR principles, BCDE principles, mock testing, test independence, test automation, assert usage, src/test/java structure, or testing best practices in Java, even if they don't explicitly mention 'Alibaba' or 'unit testing standards'.
---
