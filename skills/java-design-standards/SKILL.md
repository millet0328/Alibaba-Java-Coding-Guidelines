...
description: 阿里巴巴Java开发手册设计规约。Use when designing software architecture, applying design patterns, or making design decisions in Java projects. Make sure to use this skill whenever the user mentions system design, architecture design, UML diagrams, use case diagrams, state diagrams, sequence diagrams, class diagrams, activity diagrams, design patterns, SOLID principles, DRY principle, dependency inversion, single responsibility, open-closed principle, system boundaries, degradation strategies, weak dependencies, or software design best practices, even if they don't explicitly mention 'Alibaba' or 'design standards'.
---
