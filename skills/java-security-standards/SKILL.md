...
description: 阿里巴巴Java开发手册安全规约。Use when implementing security features, authentication, authorization, or security best practices in Java applications. Make sure to use this skill whenever the user mentions SQL injection, XSS prevention, CSRF protection, parameter validation, data masking, privacy protection, permission control, authentication, authorization, file upload security, password encryption, anti-replay attacks, or any security-related concerns in Java applications, even if they don't explicitly mention 'Alibaba' or 'security standards'.
---
